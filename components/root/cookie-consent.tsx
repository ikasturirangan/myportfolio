...
const CookieConsent: React.FC<CookieConsentProps> = ({ variant = "default", demo = false, onAcceptCallback = () => { }, onDeclineCallback = () => { } }) => {
                    ...
                    <div className="grid gap-2">
                        ...
                        <div className="p-4">
                            <p className="text-sm font-normal text-start">
                                ...
                                <br />
                                <a href="/cookie" className="text-xs underline">Learn more.</a>
                            </p>
                        </div>
                        <div className="flex gap-2 p-4 py-5 border-t border-border dark:bg-background/20">
                            <Button onClick={accept} className="w-full font-bold">Accept</Button>
                            <Button onClick={decline} className="w-full font-bold" variant="secondary">Decline</Button>
                        </div>
                    </div>
                </div>
            </div>
