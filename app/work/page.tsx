        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start lg:space-x-8">
          ...
          <div className="lg:w-3/4">
            ...
            <div className="prose prose-neutral dark:prose-invert text-justify">
              ...
              <p>
                I hold a Bachelor of Technology in Mechanical Engineering from MGMs Jawaharlal Nehru Engineering College, Aurangabad, and a Diploma in Mechanical Engineering from MGMs Polytechnic, Aurangabad. Throughout my academic journey, I have led various projects and held positions of responsibility, such as the Student Head of the Industry Institute Interaction Cell and President of the Mechanical Engineering Students Association.
              </p>
              <p>
